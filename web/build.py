...
NAV = """      <nav class="nav" aria-label="Main">
        ...
        <a href="/docs/">Docs</a>
        <a href="#" data-href="github" rel="noopener">GitHub</a>
      </nav>"""
...
SHEET = """<div class="sheet" id="sheet" hidden>
  <div class="wrap">
    ...
    <a class="item" href="#" data-href="github" rel="noopener">GitHub <small>MIT source</small></a>
    <p><a class="btn" data-cta-slot="mobile-menu" href="#">Add to Chrome — free</a></p>
  </div>
</div>"""
  ...
  <div class="wrap">
    <div class="foot-cols">
      ...
      <div><h4>Product</h4><ul>
        <li><a data-cta-slot="footer" href="#">Chrome extension</a></li>
        <li><a data-cta-slot="footer" href="#">Edge · via CWS</a></li>
        <li><a data-cta-slot="footer" href="#">Opera · via CWS</a></li>
      ...
      <div><h4>Resources</h4><ul>
        <li><a href="#" data-href="github" rel="noopener">GitHub</a></li>
    ...
    <div class="foot-bottom">
      <span>© 2026 <a href="https://zumelia.com" rel="noopener">Zumelia</a> · MIT licensed</span>
      <span class="spacer"></span>
...
def tool_block(default_tab):
    ...
    <div class="prompt" id="jb-prompt" hidden>
      ...
      <a class="btn btn-sm" data-cta-slot="tool-prompt" href="#">Add to Chrome</a>
  ...
  <section class="wrap section">
    <div class="final">
      ...
      <p class="lead" style="margin-inline:auto;max-width:52ch">The extension does this on any
        ...
        a website anyway.</p>
      <p style="margin-top:24px"><a class="btn" data-cta-slot="tool-prompt" href="#">Add to Chrome — free</a></p>
