...
(() => {
  ...
  /* Всё, что уводит с нашего домена, открывается в новой вкладке. Правило
     применяется здесь, а не расставляется руками по разметке: иначе на
     следующей странице кто-нибудь его забудет. rel обязателен — без noopener
